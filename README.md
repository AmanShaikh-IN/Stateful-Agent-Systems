...
The project integrates **LangChain**, **LangGraph**, and **AstraDB** with the help of **llama-4-maverick-17b-128e-instruct** and **Groq** to showcase dynamic tool routing, vector-based retrieval, and graph-based orchestration for multi-turn reasoning.
